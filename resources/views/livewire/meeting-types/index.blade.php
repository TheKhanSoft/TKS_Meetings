...
new class extends Component {
    ...
    {
        if (!auth()->user()->can('view meeting_types')) {
    ...
    {
        if (!auth()->user()->can('create meeting_types')) {
            abort(403);
        }
    ...
    {
        if (!auth()->user()->can('edit meeting_types')) {
            abort(403);
        }
    ...
    {
        if (!auth()->user()->can('delete meeting_types')) {
            abort(403);
        }
