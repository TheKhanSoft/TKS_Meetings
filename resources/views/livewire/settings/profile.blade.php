        ...
        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-6">
                ...
                @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail &&! auth()->user()->hasVerifiedEmail())
                    <div>
                        <p class="mt-4 text-sm text-base-content/80">
                            ...
                            <button type="button" class="text-sm font-medium link" wire:click.prevent="resendVerificationNotification">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-end">
                    <x-mary-button type="submit" class="btn-primary w-full md:w-auto" data-test="update-profile-button">
                        {{ __('Save') }}
                    </x-mary-button>
                </div>
